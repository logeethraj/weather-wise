...
// EXPORT - convert records to JSON and trigger download
export function exportAsJSON(records) {
  const json = JSON.stringify(records, null, 2);
  downloadFile(json, 'weather-records.json', 'application/json');
}

// EXPORT - convert records to CSV and trigger download
export function exportAsCSV(records) {
  ...
  downloadFile(csv, 'weather-records.csv', 'text/csv');
}
